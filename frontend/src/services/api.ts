 ...
 * ✅ FIXED: Backend NOW returns user directly at response.data (no nesting)
 */
export const getUserProfile = async (): Promise<User> => {
  ...
  try {
    ...
    // ✅ CRITICAL FIX: Backend NOW returns user directly at response.data
    const user = response.data;  // ✅ CHANGED FROM response.data.data
...
// ✅ getBadges removed - badges now come from getUserProfile()

export default api; import axios, { type InternalAxiosRequestConfig } from 'axios';
